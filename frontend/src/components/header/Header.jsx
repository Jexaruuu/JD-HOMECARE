...
const Header = () => {
  ...
  return (
    <div className="w-full flex flex-col relative">
      <div className="relative h-7/12 bg-cover bg-center transition-opacity duration-1000 flex justify-center items-center" style={{ backgroundImage: `url(${heroImages[currentImageIndex]})`, opacity: fade ? 1 : 0 }}>
        ...
        <section className="relative text-white w-full py-10 z-10 text-center flex flex-col items-center">
          ...
          <div className="mt-6 flex w-full max-w-lg justify-center">
            <input type="text" placeholder="What do you need help with?" className="border p-3 w-2/3 rounded" />
            <button className="relative inline-flex items-center justify-center px-5 py-3 bg-[#000081] rounded-lg ml-2 group overflow-hidden shadow-md cursor-pointer">
              ...
              <span className="absolute w-full h-full flex items-center justify-center text-base font-semibold text-white transition-all duration-300 transform group-hover:translate-x-full ease">Search</span>
            </button>
          </div>
        </section>
      </div>
      ...
      <div className="flex justify-center items-center w-full py-12">
        <div className="p-6 rounded-lg flex flex-col md:flex-row items-center max-w-6xl w-full">
          ...
          <div className="w-full md:w-1/2 px-6 text-center md:text-left">
            ...
            <ul className="list-disc list-inside mt-3 text-gray-700 text-[20px]">
